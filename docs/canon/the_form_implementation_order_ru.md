...
- фиксируем результат `Ball wall rebound`: импульс вверх и от стены;
- проверяем отсутствие искусственных ограничений/cooldown между последовательными `Ball wall rebound`;
