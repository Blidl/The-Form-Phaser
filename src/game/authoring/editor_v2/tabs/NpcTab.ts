...
export function createNpcTab(): AuthoringEditorTabView {
  return {
    id: 'NPC',
    render(container: HTMLElement, state: AuthoringEditorState): void {
      ...
      title.textContent = 'NPC Tab';
      title.style.margin = '0 0 6px 0';

      const description = document.createElement('p');
      description.textContent = 'Empty state: NPC authoring tools are not implemented yet.';
