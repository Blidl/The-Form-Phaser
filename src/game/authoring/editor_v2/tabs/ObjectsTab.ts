...
export function createObjectsTab(): AuthoringEditorTabView {
  return {
    id: 'Objects',
    render(container: HTMLElement, state: AuthoringEditorState): void {
      ...
      title.textContent = 'Objects Tab';
      title.style.margin = '0 0 6px 0';

      const description = document.createElement('p');
      description.textContent = 'Empty state: Object authoring tools are not implemented yet.';
