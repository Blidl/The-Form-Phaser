...
const normalizeTriggerVolume = (
    ...
    return {
        ...
        onEnterCutsceneId: asOptionalString(raw?.onEnterCutsceneId) ?? fallback.onEnterCutsceneId,
...
const normalizeTriggerVolumeArray = (
    ...
    if (rawItems === undefined) {
        return defaults.map((entry, index) => normalizeTriggerVolume({
            ...
            onEnterCutsceneId: entry.onEnterCutsceneId,
