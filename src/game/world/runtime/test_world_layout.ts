...
export const createTestWorldLayoutRuntime = (scene: Scene): TestWorldLayoutRuntime => {
    ...
    markMatterBodyAsPlatformSurface(scene.matter.add.rectangle(ground.x, ground.y, ground.width, ground.height, { isStatic: true }));
    markMatterBodyAsPlatformSurface(scene.matter.add.rectangle(lowPlatform.x, lowPlatform.y, lowPlatform.width, lowPlatform.height, { isStatic: true }));
    markMatterBodyAsPlatformSurface(scene.matter.add.rectangle(highPlatform.x, highPlatform.y, highPlatform.width, highPlatform.height, { isStatic: true }));
